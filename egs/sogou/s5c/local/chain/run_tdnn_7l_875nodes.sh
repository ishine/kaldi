...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_7l_875nodes  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
if [ $stage -le 12 ]; then
  ...
  relu-renorm-layer name=tdnn1 dim=875
  relu-renorm-layer name=tdnn2 input=Append(-1,0,1) dim=875
  relu-renorm-layer name=tdnn3 input=Append(-1,0,1) dim=875
  relu-renorm-layer name=tdnn4 input=Append(-3,0,3) dim=875
  relu-renorm-layer name=tdnn5 input=Append(-3,0,3) dim=875
  relu-renorm-layer name=tdnn6 input=Append(-3,0,3) dim=875
  relu-renorm-layer name=tdnn7 input=Append(-3,0,3) dim=875
  ## adding the layers for chain branch
  relu-renorm-layer name=prefinal-chain input=tdnn7 dim=875 target-rms=0.5
  ...
  relu-renorm-layer name=prefinal-xent input=tdnn7 dim=875 target-rms=0.5
