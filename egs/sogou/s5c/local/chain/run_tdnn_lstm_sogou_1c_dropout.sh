...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_dropout # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
label_delay=5
dropout_schedule='0,0@0.20,0.3@0.50,0@0.7,0'
# decode options
...
remove_egs=false
common_egs_dir=/search/speech/wangzhichao/kaldi/kaldi-master/egs/sogou/s5c/exp/chain/tdnn_pgru_1a_ld5/egs
...
decode_suff=6epochs_final_bigG
