...
if [ ! -z "$labels" ]; then
  ...
  labels_tr="ark,o:ali-to-pdf $alidir/final.mdl scp:$dir/scplist/ali.tr.JOB.scp ark:- | ali-to-post ark:- ark:- |"
  labels_cv="ark,o:ali-to-pdf $alidir/final.mdl scp:$dir/scplist/ali.cv.JOB.scp ark:- | ali-to-post ark:- ark:- |"
  # 
