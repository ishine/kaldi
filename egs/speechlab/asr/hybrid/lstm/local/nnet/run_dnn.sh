...
ali=exp/tri_gmm_ali_htk
dbndir=exp/dnn4b_pretrain-dbn
dir=exp/dnn4b_pretrain-dbn_dnn_htkali_asgd_svd
...
if [ $stage -le 2 ]; then
  ...
  nnet=$dir/nnet.dnn.svd0.55.init
  # --nnet-init $dir/nnet.dnn.svd0.55.init
  #--nnet-proto $dir/nnet.proto \
  (tail --pid=$$ -F $dir/log/train_nnet.log 2>/dev/null)& # forward log
  # Train
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train_asgd_htk.sh --feature-transform $feature_transform --learn-rate 0.00004 \
	--nnet-init $nnet \
