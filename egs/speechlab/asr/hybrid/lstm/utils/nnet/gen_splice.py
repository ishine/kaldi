...
parser.add_option('--splice-left', dest='splice_left', help='number of frames to concatenate with left of the central frame', default='0')
parser.add_option('--splice-right', dest='splice_right', help='number of frames to concatenate with the right of central frame', default='0')
