...
srclm=/aifs/users/wd007/asr/baseline_chn_10000h/nn/ctc/lstm/s9/data/lms/final.bg.lm.gz
srclm=/aifs/users/wd007/asr/baseline_500h/nn/ctc/phone/s6/data/lms/final.ch.en-3-gram.gz
...
[ -d $tmpdir ] || mkdir $tmpdir
    ...
    gunzip -c $srclm | find_arpa_oovs.pl words.txt  > $tmpdir/oovs_lm.txt
