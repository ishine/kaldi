...
ali=exp/tri_gmm_ali
dir=exp/dnn4b_pretrain-dbn_2048
...
if [ $stage -le 1 ]; then
  ...
  $cuda_cmd $dir/log/pretrain_dbn.log \
    steps/nnet/pretrain_dbn.sh --hid-dim 2048 --rbm-iter 2 $data_fmllr/train50_tr90 $dir || exit 1;
fi
}

ali=exp/tri_gmm_ali
dbndir=exp/dnn4b_pretrain-dbn_2048
dir=exp/dnn4b_pretrain-dbn_dnn_baseline_2048
#false && \
{
if [ $stage -le 2 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train.sh --copy-feats false --feature-transform $feature_transform --dbn $dbn --hid-layers 0 --learn-rate 0.0008 --train-opts "--verbose 1" \
