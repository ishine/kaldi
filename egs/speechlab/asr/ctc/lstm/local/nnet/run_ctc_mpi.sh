...
if [ $stage -le 1 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train_ctc_mpi.sh --network-type lstm --sort-by-len false --learn-rate 0.000002 --nnet-init $nnet \
      ...
      --train-tool "mpiexec -n 8 -f hostfile -wdir . nnet-train-ctc-parallel-mpi --global-momentum=0.90 --num-stream=15 --max-frames=15000 --objective-function=ctc " \
