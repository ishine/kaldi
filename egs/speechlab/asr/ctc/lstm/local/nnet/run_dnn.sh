...
dir=exp/dnn4b_pretrain-dbn_dnn_svd_asgd
...
if [ $stage -le 2 ]; then
  ...
  nnet=$dir/nnet.dnn.svd0.60.init
  # --nnet-init $dir/nnet.dnn.svd0.55.init
  #--nnet-proto $dir/nnet.proto \
  (tail --pid=$$ -F $dir/log/train_nnet.log 2>/dev/null)& # forward log
  # Train
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train_asgd.sh --feature-transform $feature_transform --learn-rate 0.00001 \
	--nnet-init $nnet \
    	$data_fmllr/train50_tr90 $data_fmllr/train50_cv10 data/lang $ali $ali $dir || exit 1;
fi
}
...
#false && \
{
  ...
  for test in ai_mcsnor_evl13jun_v1  ai_mcsntr_evl13mar_v1  ai_mcsntr_evl14jan_v1 ai_mcsntr_evl14mar_v1; do
        for acwt in 0.05;do
        steps/nnet/decode_dnn.sh --nj 2 --cmd "$decode_cmd" --config conf/decode_dnn.config --acwt $acwt --srcdir $dir \
