...
num_threads=10 # if >1, will use gmm-latgen-faster-parallel
...
#feats="ark:apply-cmvn --norm-vars=false scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas --delta-order=3 ark:- ark:- | transform-feats $srcdir/final.mat ark:- ark:- |"
feats="ark:apply-cmvn --norm-vars=false scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas --delta-order=2 ark:- ark:- |"
