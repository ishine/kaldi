...
head -n 40000 $dir/train.scp > $dir/train.scp.10k
...
si_feats_tr="ark:copy-feats scp:$dir/train.scp ark:- | apply-cmvn --utt2spk=ark:$data/utt2spk scp:$data/cmvn.scp ark:- ark:- |"
si_feats_cv="ark:copy-feats scp:$dir/cv.scp ark:- | apply-cmvn --utt2spk=ark:$data_cv/utt2spk scp:$data_cv/cmvn.scp ark:- ark:- |"
...
steps/nnet/train_scheduler_asgd_sds.sh \
  ...
  ${si_feats_tr:+ --si-feats-tr "$si_feats_tr"} \
  ${si_feats_cv:+ --si-feats-cv "$si_feats_cv"} \
