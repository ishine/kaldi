...
if [ ! -z "$labels" ]; then
  ...
  # 
  labels_tr="ark:copy-align  scp:$dir/scplist/ali.tr.JOB.scp ark:- |"
  labels_cv="ark:copy-align  scp:$dir/scplist/ali.cv.JOB.scp ark:- |"
  ...
  # Compute the occurrence counts of labels in the label sequences. These counts will be used to derive prior probabilities of the labels.
  [ -e $dir/label.counts ] || copy-align ark:$alidir/labels.ark ark,t:- | awk '{line=$0; gsub(" "," 0 ",line); print line " 0";}' | \
...
steps/nnet/train_scheduler_ctc_mpi.sh \
