...
if [ ! -z "$labels" ]; then
  ...
  # 
  labels_tr="ark:copy-align  scp:$alidir/ali.tr.scp ark:- |"
  labels_cv="ark:copy-align  scp:$alidir/ali.cv.scp ark:- |"
...
steps/nnet/train_scheduler_ctc.sh \
