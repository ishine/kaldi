...
cuda_cmd=run.pl
dir=exp/plstm_triphone_ce
ali=exp/triphone_ce_ali
...
if [ $stage -le 1 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train_asgd_htk.sh --network-type lstm --learn-rate 0.00005 --copy-feats false --nnet-proto $dir/nnet.proto \
