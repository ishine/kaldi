...
if [ $stage -le 2 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train_asgd_htk.sh --learn-rate 0.00003 --nnet-init $dir/nnet.init \
    --delta_opts "--delta-order=2" --online true --cmvn-opts "--cmn-window=300 --min-cmn-window=20 --norm-vars=false" \
