...
stage=0
cuda_cmd=run.pl
data_fbank=data/train_kws_v2
ali=exp/tri_kws_ali_v2
dir=exp/dnn_new_kld_v2
...
if [ $stage -le 2 ]; then
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    ...
    --splice-left 13 --splice-right 9 --online true --cmvn-opts "--cmn-window=300 --min-cmn-window=50 --norm-vars=false" --feature-transform $feature_transform \
