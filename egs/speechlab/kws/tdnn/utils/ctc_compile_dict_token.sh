...
if [ $# -ne 2 ]; then 
  echo "usage: utils/ctc_compile_dict_token.sh <dict-dir> <lang-dir>"
  echo "e.g.: utils/ctc_compile_dict_token.sh data/dict_phn data/lang_phn"
...
srcdir=$1
dir=$2
tmpdir=$dir/lang_$dict_type"_tmp"
