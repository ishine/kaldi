...
run_rescore=true
ac_model_dirs="exp/chain/tdnn_lstm_1e_sp exp/chain/lstm_6j_ld5_sp exp/chain/blstm_6k_sp exp/chain/tdnn_pgru_1e_sp exp/chain/tdnn_pgru_2e_sp"
...
text_dir=data/rnnlm/text_nosp_gru_1b
...
gru-layer name=lstm1 cell-dim=$gru_dim  vars_path=$dir/config
relu-renorm-layer name=tdnn2 dim=$embedding_dim input=Append(0, IfDefined(-3))
gru-layer name=lstm2 cell-dim=$gru_dim  vars_path=$dir/config
