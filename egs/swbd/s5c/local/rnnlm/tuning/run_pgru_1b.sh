...
run_rescore=true
ac_model_dirs="exp/chain/tdnn_pgru_1e_sp exp/chain/tdnn_pgru_2e_sp"
decode_dir_suffix=rnnlm_pgru_1b
...
text_dir=data/rnnlm/text_nosp_pgru_1b
...
pgru-layer name=lstm1 cell-dim=$embedding_dim recurrent-projection-dim=$lstm_rpd non-recurrent-projection-dim=$lstm_nrpd vars_path=$dir/config
relu-renorm-layer name=tdnn2 dim=$embedding_dim input=Append(0, IfDefined(-3))
pgru-layer name=lstm2 cell-dim=$embedding_dim recurrent-projection-dim=$lstm_rpd non-recurrent-projection-dim=$lstm_nrpd vars_path=$dir/config
