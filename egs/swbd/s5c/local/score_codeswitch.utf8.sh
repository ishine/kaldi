...
if [ $stage -le 0 ]; then
  ...
  for wip in $(echo $word_ins_penalty | sed 's/,/ /g'); do
	...
	cat $dir/scoring_kaldi/test_filt.txt | awk '{$1=""; print $0}' > $dir/scoring_kaldi/tmp
	perl ./local/zh-char-seg.pl < $dir/scoring_kaldi/tmp > $dir/scoring_kaldi/utt_tra
	rm $dir/scoring_kaldi/tmp
	...
	do
		...
		cat $dir/scoring_kaldi/penalty_$wip/$i.txt |awk '{$1=""; print $0}' > $dir/scoring_kaldi/tmp$i
		perl ./local/zh-char-seg.pl < $dir/scoring_kaldi/tmp${i} > $dir/scoring_kaldi/utt_tra
		rm $dir/scoring_kaldi/tmp${i}
