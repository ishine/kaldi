...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/blstm_1c_sogoufeat_500hours # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  fast-lstmr-layer name=blstm1-forward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=-3
  fast-lstmr-layer name=blstm1-backward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=3

  fast-lstmr-layer name=blstm2-forward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=-3
  fast-lstmr-layer name=blstm2-backward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=3

  fast-lstmr-layer name=blstm3-forward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=-3
  fast-lstmr-layer name=blstm3-backward input=Append(-2,-1,0,1,2) cell-dim=1024 recurrent-projection-dim=256 delay=3
