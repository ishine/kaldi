...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/10tdnn_8transformerBlock_chunk200_multiHead16_d1024f2048_linearProject_LC_7300h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  contextlessattention-layer name=attention8 num-heads=16 value-dim=64 key-dim=64 num-left-inputs=20 num-right-inputs=20 time-stride=3 max-change=1.0
