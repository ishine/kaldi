...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/3tdnn_3transformerBlock_linearcomponent_1700h_LR0.0004 # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn2 input=Append(-3,0,3) dim=625 max-change=1.0
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=625 max-change=1.0

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  attention-layer name=attention1 num-heads=1 value-dim=604 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
  ...
  attention-layer name=attention2 num-heads=1 value-dim=604 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
  ...
  attention-layer name=attention3 num-heads=1 value-dim=604 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
