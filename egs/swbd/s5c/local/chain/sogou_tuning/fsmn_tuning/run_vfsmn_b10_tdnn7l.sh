...
# b10 is based on b9, but using average instead of accumulate
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b10_tdnn_7l_avg  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
frames_per_eg=150
remove_egs=false
common_egs_dir=exp/chain/tdnn_7l_500h/egs
xent_regularize=0.1
