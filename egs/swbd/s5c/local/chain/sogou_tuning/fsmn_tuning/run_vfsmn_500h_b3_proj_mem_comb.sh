...
# b3 is based on b2, but we combine the projection layer and the memory block to reduce the params
#System                   vfsmn_b3    vfsmn_b2
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b3_proj_mem_combine  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
