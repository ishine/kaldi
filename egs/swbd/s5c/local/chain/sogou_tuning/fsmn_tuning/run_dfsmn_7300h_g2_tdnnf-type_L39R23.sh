...
dir=exp/chain/dfsmn_g2_15fsmn_based_tdnnf_L39R23
...
if [ $stage -le 12 ]; then
  ...
  blocksum-layer name=dfsmn4_projection_pre dim=256  input=Append(-2,-1,0) 
  ...
  blocksum-layer name=dfsmn6_projection_pre dim=256  input=Append(-2,-1,0)  
  ...
  blocksum-layer name=dfsmn8_projection_pre dim=256  input=Append(-2,-1,0) 
  ...
  blocksum-layer name=dfsmn10_projection_pre dim=256  input=Append(-3,0) 
  ...
  blocksum-layer name=dfsmn12_projection_pre dim=256  input=Append(-3,0)  
  ...
  blocksum-layer name=dfsmn14_projection_pre dim=256  input=Append(-3,0)  
