...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/dfsmn_500h_d12_6fsmn_L12R12_subsample6  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
if [ $stage -le 12 ]; then
  ...
  blocksum-layer name=dfsmn1_blocksum input=Append(-12,-6,0,6,12) dim=512
  ...
  blocksum-layer name=dfsmn2_blocksum input=Append(-12,-6,0,6,12) dim=512
  ...
  blocksum-layer name=dfsmn3_blocksum input=Append(-12,-6,0,6,12) dim=512
  ...
  blocksum-layer name=dfsmn4_blocksum input=Append(-12,-6,0,6,12) dim=512
  ...
  blocksum-layer name=dfsmn5_blocksum input=Append(-12,-6,0,6,12) dim=512
  ...
  blocksum-layer name=dfsmn6_blocksum input=Append(-12,-6,0,6,12) dim=512
