...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/dfsmn_500h_d13_8fsmn_L12R12_subsample3  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
if [ $stage -le 12 ]; then
  ...
  blocksum-layer name=dfsmn1_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn2_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn3_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn4_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn5_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn6_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn7_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  blocksum-layer name=dfsmn8_blocksum input=Append(-12,-9,-6,-3,0,3,6,9,12) dim=512
  ...
  relu-batchnorm-layer name=prefinal-chain input=dfsmn8_projection $opts dim=1536
  output-layer name=output include-log-softmax=false dim=$num_targets $output_opts

  relu-batchnorm-layer name=prefinal-xent input=dfsmn8_projection $opts dim=1536
