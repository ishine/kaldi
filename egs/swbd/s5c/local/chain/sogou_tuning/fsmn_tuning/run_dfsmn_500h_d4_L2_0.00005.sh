...
# d4 is based on d1, but we use global L2 value and set to 0.00005 as before to see whether it has great influence to DFSMN-CM.
# Conclusion:
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/dfsmn_500h_d4_L2_0.00005  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
frames_per_eg=150
remove_egs=false
common_egs_dir=exp/chain/dfsmn_500h_d1/egs
xent_regularize=0.1
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-2,-1,0,1,2) dim=1536 
  ...
  relu-batchnorm-layer name=dfsmn1_inter dim=1536  input=Sum(dfsmn1_blocksum, tdnn1l)
  ...
  relu-batchnorm-layer name=dfsmn2_inter dim=1536  input=Sum(dfsmn2_blocksum, dfsmn1_blocksum, dfsmn1_projection)
  ...
  relu-batchnorm-layer name=dfsmn3_inter dim=1536  input=Sum(dfsmn3_blocksum, dfsmn2_blocksum, dfsmn2_projection)
  ...
  relu-batchnorm-layer name=dfsmn4_inter dim=1536  input=Sum(dfsmn4_blocksum, dfsmn3_blocksum, dfsmn3_projection)
  ...
  relu-batchnorm-layer name=dfsmn5_inter dim=1536  input=Sum(dfsmn5_blocksum, dfsmn4_blocksum, dfsmn4_projection)
  ...
  relu-batchnorm-layer name=dfsmn6_inter dim=1536  input=Sum(dfsmn6_blocksum, dfsmn5_blocksum, dfsmn5_projection)
  ...
  relu-batchnorm-layer name=dfsmn7_inter dim=1536  input=Sum(dfsmn7_blocksum, dfsmn6_blocksum, dfsmn6_projection)
  ...
  relu-batchnorm-layer name=dfsmn8_inter dim=1536  input=Sum(dfsmn8_blocksum, dfsmn7_blocksum, dfsmn7_projection)
  ...
  relu-batchnorm-layer name=dfsmn9_inter dim=1536  input=Sum(dfsmn9_blocksum, dfsmn8_blocksum, dfsmn8_projection)
  linear-component name=dfsmn9_projection dim=512  $linear_opts
  ## adding the layers for chain branch
  relu-batchnorm-layer name=prefinal-chain input=dfsmn9_projection dim=1536
  output-layer name=output include-log-softmax=false dim=$num_targets $output_opts

  relu-batchnorm-layer name=prefinal-xent input=dfsmn9_projection dim=1536
