...
# a3 is based on a2, but remove renorm component from tdnn config
#System                   vfsmn_a2    vfsmn_a3
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_a5_backward_activation  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
frames_per_eg=150
remove_egs=false
common_egs_dir=exp/chain/vfsmn_500h_a2/egs
xent_regularize=0.1
