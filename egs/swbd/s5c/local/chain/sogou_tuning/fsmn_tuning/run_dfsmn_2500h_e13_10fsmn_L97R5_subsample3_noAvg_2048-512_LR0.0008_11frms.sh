...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/dfsmn_2500h_e13_10fsmn_L97R5_subsample3_noAvg_2048-512_LR0.0008_11frms  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
if [ $stage -le 12 ]; then
  ...
  blocksum-layer name=dfsmn1_blocksum input=Append(-9,-6,-3,0) dim=512 $mem_block_opts
  ...
  blocksum-layer name=dfsmn3_blocksum input=Append(-9,-6,-3,0) dim=512 $mem_block_opts
  ...
  blocksum-layer name=dfsmn5_blocksum input=Append(-9,-6,-3,0) dim=512 $mem_block_opts
  ...
  blocksum-layer name=dfsmn7_blocksum input=Append(-9,-6,-3,0) dim=512 $mem_block_opts
  ...
  blocksum-layer name=dfsmn9_blocksum input=Append(-9,-6,-3,0) dim=512 $mem_block_opts
