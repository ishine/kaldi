...
# b6 is based on b2, but using samaller learning rate
#System                   vfsmn_b6    vfsmn_b2
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b6_LR0.0008-0.0001 # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
