...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/dfsmn_7300h_f2_10fsmn_L97R20_subsample3_2048-512_2*2048_interval_skip_L2_0.001  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
frames_per_eg=150
remove_egs=false
common_egs_dir=exp/chain/dfsmn_7300h_f2_10fsmn_L97R20_subsample3_2048-512_2*2048_interval_skip_L2_0.001/egs
xent_regularize=0.1
