...
# b1 is based on a3, but using cFSMN version and increase the hidden nodes to 2048
#System                   vfsmn_b1    vfsmn_a3
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b1  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
