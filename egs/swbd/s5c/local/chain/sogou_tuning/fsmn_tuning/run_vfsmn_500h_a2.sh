...
# a2 is based on a, but reduce minibatch size from 128 to 64
#System                   vfsmn_a    vfsmn_a_2
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_a2  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
