...
# b2 is based on b1, but using linear projection layer instead of non-linear projection layer
#System                   vfsmn_b2    vfsmn_b1
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b2_linear_project  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
