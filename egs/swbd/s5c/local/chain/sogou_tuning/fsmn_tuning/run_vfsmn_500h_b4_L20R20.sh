...
# b4 is based on b2, but we expand the memory context to L20 R20
#System                   vfsmn_b4    vfsmn_b2
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b4_L20R20  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
