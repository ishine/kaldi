...
# b8 is based on b2, but we use separate elementscale vector for each t
#System                   vfsmn_b8    vfsmn_b2
set -e
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/vfsmn_500h_b8_separate_ElementScale  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
