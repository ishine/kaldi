...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/lstm_6j_1024_256_sogoufeat_500h_1.0_1.1_1.2_2epoch # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/lstm_6j_1024_256_sogoufeat_500h_1.0_1.1_1.2_3epoch_ld5_sp/egs
...
dir=${dir}$suffix
train_set=train_sogou_fbank_500h_sp1.0_1.1_1.2
