...
dir=exp/chain/tdnnf_1a_15l_1536_160_L2-0.001_L25R25_LFR
...
#  affine_opts="l2-regularize=0.0 dropout-proportion=0.0 dropout-per-dim=true dropout-per-dim-continuous=true"
  tdnnf_opts="bypass-scale=0.66 l2-regularize=0.001"
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-1,0,1) dim=1536 l2-regularize=0.001
  ...
  tdnnf-layer name=tdnnf7 $tdnnf_opts dim=1536 bottleneck-dim=480 time-stride=0
  tdnnf-layer name=tdnnf8 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=1536 bottleneck-dim=480 time-stride=0
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=1536 bottleneck-dim=480 time-stride=0
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=1536 bottleneck-dim=480 time-stride=0
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=1536 bottleneck-dim=480 time-stride=0
