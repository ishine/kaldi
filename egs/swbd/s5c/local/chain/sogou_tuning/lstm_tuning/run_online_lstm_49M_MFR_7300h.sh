...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_online_49M_MRF_7300h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  fast-lstmr-layer name=fastlstm1 input=Append(-2,-1,0,1,2) cell-dim=2560 recurrent-projection-dim=768 delay=-1
