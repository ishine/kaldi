...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_sogou_2500h_18M_addNoisy_cleanLats # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 13 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --tree-dir $treedir \
    --lat-dir exp/tri3b_lats_SogouAppenFakeNoisy_combine \
    --dir $dir  || exit 1;
fi
<<!
if [ $stage -le 14 ]; then
