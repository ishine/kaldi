...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_online_49M_5000states_7000h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
treedir=exp/chain/tri5_7000houres_5000states_tree
