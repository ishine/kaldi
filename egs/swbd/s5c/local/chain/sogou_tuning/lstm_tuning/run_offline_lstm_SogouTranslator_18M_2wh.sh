...
get_egs_stage=5
speed_perturb=false
dir=exp/chain/lstm_6j_offline_SogouTranslator_18M_2w # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
frames_per_chunk=
frames_per_chunk_primary=$(echo $chunk_width | cut -d, -f1)

remove_egs=false
common_egs_dir=/public/speech/wangzhichao/kaldi/kaldi-wzc/egs/sogou/s5c/exp/chain/lstm_6j_offline_SogouTranslator_18M_2w_ld5/egs
...
graph_dir=/public/speech/wangzhichao/kaldi/kaldi-wzc/egs/sogou/s5c/exp/chain/lstm_6j_16k_500h_ld5/graph_offline_bin
#decode_suff=online
