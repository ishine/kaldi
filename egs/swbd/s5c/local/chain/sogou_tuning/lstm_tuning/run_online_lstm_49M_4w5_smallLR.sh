...
if [ $stage -le 14 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 data/lang_shurufa $dir $dir/graph_shurufa
fi
!

decode_suff=online
graph_dir=exp/chain/lstm_6j_online_49M_4w5_ld5/graph_online
