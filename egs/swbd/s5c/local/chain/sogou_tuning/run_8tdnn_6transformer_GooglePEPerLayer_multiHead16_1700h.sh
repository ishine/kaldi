...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/8tdnn_6transformerBlock_fullAttention_GooglePEPerLayer_chunk200_multiHead16_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=624

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  positionembedding-layer name=positionembedding1
  contextlessattention-layer name=attention1 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  relu-batchnorm-layer name=tdnn4 input=Append(-3,0,3) dim=624
  positionembedding-layer name=positionembedding2
  contextlessattention-layer name=attention2 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  relu-batchnorm-layer name=tdnn5 input=Append(-3,0,3) dim=624
  positionembedding-layer name=positionembedding3
  contextlessattention-layer name=attention3 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  relu-batchnorm-layer name=tdnn6 input=Append(-3,0,3) dim=624
  positionembedding-layer name=positionembedding4
  contextlessattention-layer name=attention4 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  relu-batchnorm-layer name=tdnn7 input=Append(-3,0,3) dim=624
  positionembedding-layer name=positionembedding5
  contextlessattention-layer name=attention5 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  relu-batchnorm-layer name=tdnn8 input=Append(-3,0,3) dim=624
  positionembedding-layer name=positionembedding6
  contextlessattention-layer name=attention6 num-heads=16 value-dim=39 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3
