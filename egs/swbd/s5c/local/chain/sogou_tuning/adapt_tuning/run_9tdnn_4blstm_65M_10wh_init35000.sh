...
get_egs_stage=5
speed_perturb=false
dir=exp/chain/9tdnn_4blstm_65M_10wh_adapt_init35000_2epoch # Note: _sp will get added to this if $speed_perturb == true.
src_mdl=exp/chain/9tdnn_4blstm_65M_10wh_adapt_init35000_2epoch/src_final_mdl/35000.mdl
