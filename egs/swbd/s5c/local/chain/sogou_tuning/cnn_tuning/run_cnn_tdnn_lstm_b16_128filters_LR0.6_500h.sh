...
# run_cnn_tdnn_lstm_b16_128filters_LR0.6_500h.sh is like run_cnn_tdnn_lstm_b14_128filters_5x15_500h.sh but increase the cnn learning-rate-factor to 0.6
# kernel size: 5*15
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/cnn_tdnn_lstm_b16_128filters_LR0.6_500h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/cnn_tdnn_lstm_b14_128filters_5x15_500h_ld5/egs
