...
# run_cnn_tdnn_lstm_b9_128filters_3x15_500h.sh is like run_cnn_tdnn_lstm_b2_128filters_500h.sh but using different kernel size (3*15 vs 3*9)
# kernel size: 3*15
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/cnn_tdnn_lstm_b9_128filters_3x15_500h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/cnn_tdnn_lstm_b1_500h_ld5/egs
