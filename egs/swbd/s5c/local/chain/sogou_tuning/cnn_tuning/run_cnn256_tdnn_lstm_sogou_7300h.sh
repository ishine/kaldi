...
# run_cnn256_tdnn_lstm_sogou_7300h.sh is like run_tdnn_lstm_sogou_7300h.sh but add one cnn layer at the bottom of NN
# kernel size 3*15 
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/cnn256_tdnn_lstm_1c_sogoufeat_7300hours # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
