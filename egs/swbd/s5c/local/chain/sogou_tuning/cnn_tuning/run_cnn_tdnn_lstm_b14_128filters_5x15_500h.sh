...
# run_cnn_tdnn_lstm_b14_128filters_3x15_500h.sh is like run_cnn_tdnn_lstm_b9_128filters_3x15_500h.sh but using different kernel size (5*15 vs 3*15)
# kernel size: 3*15
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/cnn_tdnn_lstm_b15_128filters_5x15_500h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
