...
# run_cnn_tdnn_lstm_attend_500h.sh is the combination of run_cnn_tdnn_lstm_b9_128filters_3x15_500h.sh and run_tdnn_lstm_attend_a1.sh i.e. we add a convolution layer at the bottom of NN and replace tdnn7 with a multi-head-attention layer
# kernel size: 3*15
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/cnn_tdnn_lstm_attend_a1_500h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/cnn_tdnn_lstm_attend_500h_ld5/egs
