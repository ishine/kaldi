...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_1024_256_sogoufeat_500h_LM3000states # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/lstm_6j_1024_256_sogoufeat_500h_ld5/egs
...
if [ $stage -le 13 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --chain.lm-opts="--num-extra-lm-states=3000" \
...
decode_suff=online
graph_dir=exp/chain/lstm_6j_online_sogoufeat_7000h_ld5/graph_online
if [ $stage -le 15 ]; then
