...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/3tdnn_3blstm_43M_chunk200_LC80_7300h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
frames_per_chunk=200,150,100
#frames_per_chunk_primary=$(echo $frames_per_chunk | cut -d, -f1)
frames_per_chunk_primary=100000
