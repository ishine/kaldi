...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/6transformerBlock_fullAttention_googlePE_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  positionembedding-layer name=positionembedding
  ...
  batchnorm-component name=atten1.batchnorm1 input=Sum(positionembedding, attention1)
