...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/2tdnn_6transformerMH8_allLinear_3blstm_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/2tdnn_6transformerMH8_3blstm_1700h/egs
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-2,-1,0,1,2) dim=624
  relu-batchnorm-layer name=tdnn2 input=Append(-3,0,3) dim=624

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  positionembedding-layer name=positionembedding1
  contextlessattention-layer name=attention1 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten1.feedforward2 orthonormal-constraint=-1.0 dim=624
  ...
  contextlessattention-layer name=attention2 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten2.feedforward2 orthonormal-constraint=-1.0 dim=624                          
  batchnorm-component name=atten2.batchnorm2 input=Sum(atten2.batchnorm1, atten2.feedforward2)  
  fast-lstmr-layer name=blstm1-forward input=atten2.batchnorm2 cell-dim=1024 recurrent-projection-dim=192 delay=-3
  fast-lstmr-layer name=blstm1-backward input=atten2.batchnorm2 cell-dim=1024 recurrent-projection-dim=192 delay=3
  linear-component name=tdnn3 orthonormal-constraint=-1.0 input=Append(blstm1-forward, blstm1-backward) dim=624
  positionembedding-layer name=positionembedding3
  contextlessattention-layer name=attention3 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten3.feedforward2 orthonormal-constraint=-1.0 dim=624                          
  ...
  contextlessattention-layer name=attention4 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten4.feedforward2 orthonormal-constraint=-1.0 dim=624                          
  batchnorm-component name=atten4.batchnorm2 input=Sum(atten4.batchnorm1, atten4.feedforward2)
  fast-lstmr-layer name=blstm2-forward input=atten4.batchnorm2 cell-dim=768 recurrent-projection-dim=192 delay=-3
  fast-lstmr-layer name=blstm2-backward input=atten4.batchnorm2 cell-dim=768 recurrent-projection-dim=192 delay=3
  linear-component name=tdnn4 orthonormal-constraint=-1.0 input=Append(blstm2-forward, blstm2-backward) dim=624
  positionembedding-layer name=positionembedding5
  contextlessattention-layer name=attention5 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten5.feedforward2 orthonormal-constraint=-1.0 dim=624                          
  ...
  contextlessattention-layer name=attention6 num-heads=8 value-dim=78 key-dim=64 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten6.feedforward2 orthonormal-constraint=-1.0 dim=624                          
  batchnorm-component name=atten6.batchnorm2 input=Sum(atten6.batchnorm1, atten6.feedforward2)
  fast-lstmr-layer name=blstm3-forward input=atten6.batchnorm2 cell-dim=768 recurrent-projection-dim=192 delay=-3
  fast-lstmr-layer name=blstm3-backward input=atten6.batchnorm2 cell-dim=768 recurrent-projection-dim=192 delay=3
  relu-batchnorm-layer name=prefinal input=Append(blstm3-forward, blstm3-backward) dim=1024
