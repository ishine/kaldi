...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/8tdnn_6transformerBlock_fullAttention_GooglePEPerLayer_chunk200_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/8tdnn_6transformerBlock_fullAttention_GooglePEPerLayer_chunk200_1700h/egs
