...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/12tdnn_10transformerBlock_chunk200_multiHead16_d768k512f2048_linearProject_7300h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-2,-1,0,1,2) dim=768
  relu-batchnorm-layer name=tdnn2 input=Append(-3,0,3) dim=768 max-change=1.0
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=768 max-change=1.0

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  positionembedding-layer name=positionembedding1
  contextlessattention-layer name=attention1 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten1.linear orthonormal-constraint=-1.0 dim=384
  affine-layer name=atten1.feedforward2 dim=768
  batchnorm-component name=atten1.batchnorm2 input=Sum(atten1.batchnorm1, atten1.feedforward2)
  relu-batchnorm-layer name=tdnn4 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding2
  contextlessattention-layer name=attention2 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten2.linear orthonormal-constraint=-1.0 dim=384
  affine-layer name=atten2.feedforward2 dim=768
  batchnorm-component name=atten2.batchnorm2 input=Sum(atten2.batchnorm1, atten2.feedforward2)  
  relu-batchnorm-layer name=tdnn5 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding3
  contextlessattention-layer name=attention3 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten3.linear orthonormal-constraint=-1.0 dim=384
  affine-layer name=atten3.feedforward2 dim=768                      
  batchnorm-component name=atten3.batchnorm2 input=Sum(atten3.batchnorm1, atten3.feedforward2)
  relu-batchnorm-layer name=tdnn6 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding4
  contextlessattention-layer name=attention4 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten4.linear orthonormal-constraint=-1.0 dim=384                    
  affine-layer name=atten4.feedforward2 dim=768                  
  batchnorm-component name=atten4.batchnorm2 input=Sum(atten4.batchnorm1, atten4.feedforward2)
  relu-batchnorm-layer name=tdnn7 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding5
  contextlessattention-layer name=attention5 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten5.linear orthonormal-constraint=-1.0 dim=384                       
  affine-layer name=atten5.feedforward2 dim=768                         
  batchnorm-component name=atten5.batchnorm2 input=Sum(atten5.batchnorm1, atten5.feedforward2)
  relu-batchnorm-layer name=tdnn8 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding6
  contextlessattention-layer name=attention6 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten6.linear orthonormal-constraint=-1.0 dim=384                           
  affine-layer name=atten6.feedforward2 dim=768                       
  batchnorm-component name=atten6.batchnorm2 input=Sum(atten6.batchnorm1, atten6.feedforward2)
  relu-batchnorm-layer name=tdnn9 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding7
  contextlessattention-layer name=attention7 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten7.linear orthonormal-constraint=-1.0 dim=384                         
  affine-layer name=atten7.feedforward2 dim=768                       
  batchnorm-component name=atten7.batchnorm2 input=Sum(atten7.batchnorm1, atten7.feedforward2)  
  relu-batchnorm-layer name=tdnn10 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding8
  contextlessattention-layer name=attention8 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten8.linear orthonormal-constraint=-1.0 dim=384                         
  affine-layer name=atten8.feedforward2 dim=768                      
  batchnorm-component name=atten8.batchnorm2 input=Sum(atten8.batchnorm1, atten8.feedforward2)
  relu-batchnorm-layer name=tdnn11 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding9
  contextlessattention-layer name=attention9 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten9.linear orthonormal-constraint=-1.0 dim=384                          
  affine-layer name=atten9.feedforward2 dim=768                       
  batchnorm-component name=atten9.batchnorm2 input=Sum(atten9.batchnorm1, atten9.feedforward2)
  relu-batchnorm-layer name=tdnn12 input=Append(-3,0,3) dim=768 max-change=1.0
  positionembedding-layer name=positionembedding10
  contextlessattention-layer name=attention10 num-heads=16 value-dim=48 key-dim=32 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.0
  ...
  linear-component name=atten10.linear orthonormal-constraint=-1.0 dim=384                           
  affine-layer name=atten10.feedforward2 dim=768                      
