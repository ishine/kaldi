...
get_egs_stage=-10
speed_perturb=false
dir=/public/speech/wangzhichao/kaldi/kaldi-wzc/egs/sogou/s5c/exp/chain/12tdnn_10transformerBlockIncludeTdnn_multiHead8_d1024f2048_10wh # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=1280 max-change=1.2

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  positionembedding-layer name=positionembedding1
  contextlessattention-layer name=attention1 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten1.batchnorm1 input=Sum(positionembedding1, attention1)
  relu-layer name=atten1.feedforward1 dim=3072 max-change=1.2
  linear-component name=atten1.linear orthonormal-constraint=-1.0 dim=768
  affine-layer name=atten1.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0 
  ...
  contextlessattention-layer name=attention2 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten2.batchnorm1 input=Sum(positionembedding2, attention2)
  relu-layer name=atten2.feedforward1 dim=3072 max-change=1.2                           
  linear-component name=atten2.linear orthonormal-constraint=-1.0 dim=768
  affine-layer name=atten2.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0
  ...
  contextlessattention-layer name=attention3 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten3.batchnorm1 input=Sum(positionembedding3, attention3)
  relu-layer name=atten3.feedforward1 dim=3072 max-change=1.2                           
  linear-component name=atten3.linear orthonormal-constraint=-1.0 dim=768
  affine-layer name=atten3.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                      
  ...
  contextlessattention-layer name=attention4 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten4.batchnorm1 input=Sum(positionembedding4, attention4)
  relu-layer name=atten4.feedforward1 dim=3072 max-change=1.2       
  linear-component name=atten4.linear orthonormal-constraint=-1.0 dim=768                    
  affine-layer name=atten4.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                  
  ...
  contextlessattention-layer name=attention5 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten5.batchnorm1 input=Sum(positionembedding5, attention5)
  relu-layer name=atten5.feedforward1 dim=3072 max-change=1.2    
  linear-component name=atten5.linear orthonormal-constraint=-1.0 dim=768                       
  affine-layer name=atten5.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                         
  ...
  contextlessattention-layer name=attention6 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten6.batchnorm1 input=Sum(positionembedding6, attention6)
  relu-layer name=atten6.feedforward1 dim=3072 max-change=1.2
  linear-component name=atten6.linear orthonormal-constraint=-1.0 dim=768                           
  affine-layer name=atten6.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                       
  ...
  contextlessattention-layer name=attention7 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten7.batchnorm1 input=Sum(positionembedding7, attention7)
  relu-layer name=atten7.feedforward1 dim=3072 max-change=1.2  
  linear-component name=atten7.linear orthonormal-constraint=-1.0 dim=768                         
  affine-layer name=atten7.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                       
  ...
  contextlessattention-layer name=attention8 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten8.batchnorm1 input=Sum(positionembedding8, attention8)
  relu-layer name=atten8.feedforward1 dim=3072 max-change=1.2  
  linear-component name=atten8.linear orthonormal-constraint=-1.0 dim=768                         
  affine-layer name=atten8.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                      
  ...
  contextlessattention-layer name=attention9 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten9.batchnorm1 input=Sum(positionembedding9, attention9)
  relu-layer name=atten9.feedforward1 dim=3072 max-change=1.2 
  linear-component name=atten9.linear orthonormal-constraint=-1.0 dim=768                          
  affine-layer name=atten9.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                       
  ...
  contextlessattention-layer name=attention10 num-heads=8 value-dim=160 key-dim=160 num-left-inputs=0 num-right-inputs=0 time-stride=3 max-change=1.2
  batchnorm-component name=atten10.batchnorm1 input=Sum(positionembedding10, attention10)
  relu-layer name=atten10.feedforward1 dim=3072 max-change=1.2
  linear-component name=atten10.linear orthonormal-constraint=-1.0 dim=768                           
  affine-layer name=atten10.feedforward2 input=Append(-3,0,3) dim=1280 max-change=1.0                      
  batchnorm-component name=atten10.batchnorm2 input=Sum(atten10.batchnorm1, atten10.feedforward2)
  relu-batchnorm-layer name=prefinal dim=1280
