...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/3tdnn_3AttendBatchnorm_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  attention-relu-batchnorm-layer name=attention1 num-heads=1 value-dim=1024 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
  attention-relu-batchnorm-layer name=attention2 num-heads=1 value-dim=1024 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
  attention-relu-batchnorm-layer name=attention3 num-heads=1 value-dim=1024 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
