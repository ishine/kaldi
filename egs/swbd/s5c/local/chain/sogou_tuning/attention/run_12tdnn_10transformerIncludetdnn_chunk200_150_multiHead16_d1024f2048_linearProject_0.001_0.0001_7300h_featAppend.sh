...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/12tdnn_10transformerBlockIncludeTdnn_chunk200_150_multiHead16_d1024f2048_linearProject_0.001_0.0001_7300h_featAppend # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  affine-layer name=atten1.feedforward2 input=Append(-3,0,3) dim=1024
  ...
  affine-layer name=atten2.feedforward2 input=Append(-3,0,3) dim=1024
  ...
  affine-layer name=atten3.feedforward2 input=Append(-3,0,3) dim=1024                      
  ...
  affine-layer name=atten4.feedforward2 input=Append(-3,0,3) dim=1024                  
  ...
  affine-layer name=atten5.feedforward2 input=Append(-3,0,3) dim=1024                         
  batchnorm-component name=atten5.batchnorm2 input=Sum(atten5.batchnorm1, atten5.feedforward2)
  linear-component name=feat.combine input=Append(tdnn3, atten5.batchnorm2) dim=1024
  ...
  affine-layer name=atten6.feedforward2 input=Append(-3,0,3) dim=1024                       
  ...
  affine-layer name=atten7.feedforward2 input=Append(-3,0,3) dim=1024                       
  ...
  affine-layer name=atten8.feedforward2 input=Append(-3,0,3) dim=1024                      
  ...
  affine-layer name=atten9.feedforward2 input=Append(-3,0,3) dim=1024                       
  ...
  affine-layer name=atten10.feedforward2 input=Append(-3,0,3) dim=1024                      
