...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/8tdnn_6transformerBlock_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  attention-layer name=attention1 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention2 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  batchnorm-component name=atten2.batchnorm1 input=Sum(tdnn4, attention2)
  ...
  attention-layer name=attention3 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  batchnorm-component name=atten3.batchnorm1 input=Sum(tdnn5, attention3)
  ...
  attention-layer name=attention4 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  batchnorm-component name=atten4.batchnorm1 input=Sum(tdnn6, attention4)
  ...
  attention-layer name=attention5 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  batchnorm-component name=atten5.batchnorm1 input=Sum(tdnn7, attention5)
  ...
  attention-layer name=attention6 num-heads=1 value-dim=608 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  batchnorm-component name=atten6.batchnorm1 input=Sum(tdnn8, attention6)
