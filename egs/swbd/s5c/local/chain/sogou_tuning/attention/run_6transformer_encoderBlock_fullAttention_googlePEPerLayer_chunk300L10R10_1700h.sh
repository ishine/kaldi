...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/6transformerBlock_fullAttention_googlePEPerLayer_chunk300L10R10_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  selfattention-layer name=attention6 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=10 num-right-inputs=10 time-stride=3
