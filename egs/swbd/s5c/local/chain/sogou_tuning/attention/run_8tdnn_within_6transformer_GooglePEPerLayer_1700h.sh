...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/8tdnn_within_6transformerBlock_fullAttention_GooglePEPerLayer_chunk200_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn2 input=Append(-3,0,3) dim=625
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=625

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  positionembedding-layer name=positionembedding1
  selfattention-layer name=attention1 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten1.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten1.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten1.batchnorm2 input=Sum(atten1.batchnorm1, atten1.tdnn1)
  positionembedding-layer name=positionembedding2
  selfattention-layer name=attention2 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten2.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten2.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten2.batchnorm2 input=Sum(atten2.batchnorm1, atten2.tdnn1)  
  positionembedding-layer name=positionembedding3
  selfattention-layer name=attention3 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten3.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten3.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten3.batchnorm2 input=Sum(atten3.batchnorm1, atten3.tdnn1)
  positionembedding-layer name=positionembedding4
  selfattention-layer name=attention4 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten4.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten4.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten4.batchnorm2 input=Sum(atten4.batchnorm1, atten4.tdnn1)
  positionembedding-layer name=positionembedding5
  selfattention-layer name=attention5 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten5.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten5.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten5.batchnorm2 input=Sum(atten5.batchnorm1, atten5.tdnn1)
  positionembedding-layer name=positionembedding6
  selfattention-layer name=attention6 num-heads=1 value-dim=625 key-dim=512 num-left-inputs=0 num-right-inputs=0 time-stride=3
  ...
  linear-component name=atten6.feedforward2 orthonormal-constraint=-1.0 dim=625
  affine-layer name=atten6.tdnn1 input=Append(-3,0,3) dim=625
  batchnorm-component name=atten6.batchnorm2 input=Sum(atten6.batchnorm1, atten6.tdnn1)
