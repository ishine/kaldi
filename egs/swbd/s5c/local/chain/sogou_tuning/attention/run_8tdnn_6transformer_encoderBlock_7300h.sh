...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/8tdnn_6transformerBlock_7300h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  attention-layer name=attention6 num-heads=1 value-dim=594 key-dim=512 num-left-inputs=15 num-right-inputs=15 time-stride=3
