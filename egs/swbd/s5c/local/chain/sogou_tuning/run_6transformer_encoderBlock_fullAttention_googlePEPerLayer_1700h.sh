...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/6transformerBlock_fullAttention_googlePEPerLayer_LC20input_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
