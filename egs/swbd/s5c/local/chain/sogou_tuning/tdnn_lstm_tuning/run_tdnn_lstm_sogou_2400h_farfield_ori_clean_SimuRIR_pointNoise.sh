...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_2400h_farfield_ori_clean_SimuRIR_pointNoise_LFR_noLD # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/tdnn_lstm_1c_2400h_farfield_ori_clean_SimuRIR_pointNoise_LFR_noLD/egs
...
dir=${dir}$suffix
train_set=train_sogou_fbank_2400h_farfield_ori_clean_SimuRIR_pointSnoise
