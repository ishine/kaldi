...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_2400h_farfield_ori_clean_kaldi_fbank_LFR_noLD # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
dir=${dir}$suffix
train_set=train_kaldi_fbank_2400h_farfield_ori_clean
...
if [ $stage -le 15 ]; then
  ...
  for decode_set in not_on_screen_kaldi_d71 test8000_kaldi_d71 testIOS_kaldi_d71 testset_testND_kaldi_d71; do
      (
