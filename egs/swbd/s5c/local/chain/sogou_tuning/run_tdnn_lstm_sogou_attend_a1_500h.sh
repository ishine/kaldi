...
# run_tdnn_lstm_attend_a1.sh is like run_tdnn_lstm_attend.sh but using three lstm layers
...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_attend_a1_500h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
