...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/12transformerBlock_bigContext_1700h # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  attention-layer name=attention1 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention2 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention3 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention4 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention5 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention6 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention7 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention8 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention9 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention10 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention11 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
  ...
  attention-layer name=attention12 num-heads=1 value-dim=495 key-dim=512 num-left-inputs=8 num-right-inputs=8 time-stride=3
