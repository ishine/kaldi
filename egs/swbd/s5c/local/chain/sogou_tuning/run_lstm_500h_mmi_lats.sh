...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_mmi_lats_500h_tolearance3
decode_iter=
decode_dir_affix=
...
treedir=exp/chain/tri5_mmi_7000houres_tree$suffix
...
decode_suff=online
graph_dir=exp/chain/lstm_6j_mmi_lats_500h_ld5/graph_online
if [ $stage -le 15 ]; then
