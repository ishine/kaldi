...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_sogoufeat_7300hours_noLD_syllable_ali_unconstrain # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/tdnn_lstm_1c_sogoufeat_7300hours_noLD_syllable_ali_unconstrain/egs
...
ali_dir=exp/tri3b_ali_syllable_length
...
if [ $stage -le 13 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --tree-dir $treedir \
    --lat-dir exp/tri3b_ali_syllable_length \
    --dir $dir  || exit 1;
fi
