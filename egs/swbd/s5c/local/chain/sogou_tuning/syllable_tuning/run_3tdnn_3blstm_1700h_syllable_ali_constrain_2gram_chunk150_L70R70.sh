...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/3tdnn_3blstm_1700h_5s_syllable_ali_constrain_2gram_L70R70_chunk150 # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
chunk_width=150
chunk_left_context=70
chunk_right_context=70
...
if [ $stage -le 12 ]; then
  ...
  relu-renorm-layer name=tdnn2 input=Append(-3,0,3) dim=625 max-change=1.0
  relu-renorm-layer name=tdnn3 input=Append(-3,0,3) dim=625 max-change=1.0
...
!
decode_suff=0528_decode1.5s
graph_dir=exp/chain/tdnn_lstm_1c_sogoufeat_1700hours_noLD_syllable_ali_constrain_5s_3gram_denfst/graph_0528_syllable
if [ $stage -le 15 ]; then
