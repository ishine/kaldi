...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/2tdnn_6transformerMH8_3blstm_1700h_nnet3Lats_LFR4_syllable # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
if [ $stage -le 12 ]; then
  ...
  affine-layer name=atten1.feedforward2 dim=624
  ...
  affine-layer name=atten2.feedforward2 dim=624                          
  ...
  relu-batchnorm-layer name=tdnn3 input=Append(blstm1-forward, blstm1-backward) dim=624
  ...
  affine-layer name=atten3.feedforward2 dim=624                          
  ...
  affine-layer name=atten4.feedforward2 dim=624                          
  ...
  relu-batchnorm-layer name=tdnn4 input=Append(blstm2-forward, blstm2-backward) dim=624
  ...
  affine-layer name=atten5.feedforward2 dim=624                          
  ...
  affine-layer name=atten6.feedforward2 dim=624                          
...
if [ $stage -le 13 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --tree-dir $treedir \
    --lat-dir /public/speech/wangzhichao/kaldi/kaldi-wzc/egs/sogou/s5c/exp/chain/tdnn_lstm_1c_sogoufeat_1700hours_noLD_syllable_ali_constrain_5s_2gram_denfst_LFR4_lats_beam20 \
    --dir $dir  || exit 1;
fi
<<!
if [ $stage -le 14 ]; then
...
!
decode_suff=0528
graph_dir=exp/chain/tdnn_lstm_1c_sogoufeat_1700hours_noLD_syllable_ali_constrain_5s_2gram_denfst_nnet3Lats_retrain_tolerance2/graph_0528_syllable
if [ $stage -le 15 ]; then
