...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_sogoufeat_1700hours_noLD_syllable_ali_constrain_5s_2gram_denfst_L5R5_LFR6-1-3-6_newTree # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
treedir=exp/chain/tri5_7000houres_mono_tree_syllable_7300h_part
lang=data/lang_0528_syllable_7300h_part_phones
...
if [ $stage -le 13 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --tree-dir $treedir \
    --lat-dir exp/tri3b_ali_syllable1346_length_1700h_5s \
    --dir $dir  || exit 1;
fi
...
if [ $stage -le 14 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 data/lang_0528_syllable_7300h_part_phones $dir $dir/graph_0528_syllable
fi

decode_suff=0528_decode15s
graph_dir=$dir/graph_0528_syllable
if [ $stage -le 15 ]; then
