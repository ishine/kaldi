...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/tdnn_lstm_1c_sogoufeat_1600hours_1.5s-3s_noLD_syllable_ali_whole_sentence # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
ali_dir=exp/tri3b_ali_syllable_length_1600h_1.5s-3s
