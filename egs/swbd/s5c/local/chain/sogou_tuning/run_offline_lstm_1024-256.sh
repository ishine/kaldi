...
get_egs_stage=-10
speed_perturb=false
dir=exp/chain/lstm_6j_offline_1024_256 # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/lstm_6j_8job_cmvn_ld5/egs
...
if [ $stage -le 14 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 data/lang_online_1 $dir $dir/graph_online_1
fi


decode_suff=online_1
graph_dir=$dir/graph_online_1
if [ $stage -le 15 ]; then
