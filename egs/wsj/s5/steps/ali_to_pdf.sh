...
if [ $# != 2 ]; then
   echo "usage: steps/align_to_pdf.sh <align-dir> <pdf-dir>"
   echo "e.g.:  steps/align_to_pdf.sh exp/tri1_ali exp/tri1_ali_pdf"
...
$cmd JOB=1:$nj $dir/log/ali_to_pdf.JOB.log \
  ali-to-pdf $srcdir/final.mdl "ark:gunzip -c $srcdir/ali.JOB.gz|" "ark,t:$dir/ali.JOB.pdf"
