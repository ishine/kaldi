...
config_to_layer = {
        ...
        'attention-layer': xlayers.XconfigAttentionLayer,
        'relu-renorm-attention-layer': xlayers.XconfigAttentionLayer,
        'selfattention-layer': xlayers.XconfigSelfAttentionLayer,
        'contextlessattention-layer': xlayers.XconfigContextlessAttentionLayer,
        'positionembedding-layer': xlayers.XconfigPositionEmbeddingLayer,
