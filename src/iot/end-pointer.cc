...
bool EndPointer::Detected(const DecCore &dec_core) {
  int32 trailing_silence  = config_.decoder_frame_shift * dec_core.TrailingSilenceFrames();
  int32 utterance_length  = config_.decoder_frame_shift * dec_core.NumFramesDecoded();
