...
struct MaceOnlineNnet2DecodingConfig {
  
  LatticeFasterDecoderConfig decoder_opts;
  MACE::MaceDecodableNnet2OnlineOptions decodable_opts;
  
  MaceOnlineNnet2DecodingConfig() {  decodable_opts.acoustic_scale = 0.1; }
...
class MaceSingleUtteranceNnet2Decoder {
 public:
  ...
  MaceSingleUtteranceNnet2Decoder(const MaceOnlineNnet2DecodingConfig &config,
 ...
 private:
  ...
  MaceOnlineNnet2DecodingConfig config_;
