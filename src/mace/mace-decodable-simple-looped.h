...
struct MaceSimpleLoopedComputationOptions {
  int32 left_context;
  int32 right_context;
  int32 modulus;
...
class MaceDecodableNnetSimpleLoopedInfo  {
 public:
  ...
  MaceDecodableNnetSimpleLoopedInfo(const MaceSimpleLoopedComputationOptions &opts,
  ...
  void Init(const MaceSimpleLoopedComputationOptions &opts,
            MaceComputer *computer);

  const MaceSimpleLoopedComputationOptions &opts;
