// nnet0/nnet-train-chain-parallel-mpi.cc
...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        "Train nnet0+chain one iteration of Neural Network training by mini-batch Stochastic Gradient Descent in multi-machine.\n"
        ...
        "e.g.: \n"
        " nnet-train-chain-parallel-mpi den.fst 'ark:nnet3-merge-egs 1.cegs ark:-|' nnet.init nnet.iter1\n";
