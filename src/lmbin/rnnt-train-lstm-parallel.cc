// lm/rnnt-train-lstm-parallel.cc
...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        ...
        "This version use for rnn transducer sequence to sequence training.\n"
        "Usage:  rnnt-train-lstm-parallel [options] <feature-rspecifier> <word-rspecifier> <model-in> [<model-out>]\n"
        "e.g.: \n"
        " rnnt-train-lstm-parallel scp:feature.scp scp:target_word.scp nnet.init nnet.iter1\n";
    ...
    RNNTLstmUpdateOptions opts(&trn_opts, &rnd_opts, &spec_opts, 
