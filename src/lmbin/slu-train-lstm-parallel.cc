...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        ...
        "This version use for Joint Online Spoken Language Understanding and Language Modeling training.\n"
        "Usage:  slu-train-lstm-parallel [options] <feature-rspecifier> <model-in> [<model-out>]\n"
        "e.g.: \n"
        " slu-train-lstm-parallel scp:feature.scp nnet.init nnet.iter1\n";
