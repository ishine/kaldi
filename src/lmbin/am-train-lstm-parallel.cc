...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
		...
		"Usage:  am-train-lstm-streams-parallel [options] <feature-rspecifier> <targets-rspecifier> <model-in> [<model-out>]\n"
		"e.g.: \n"
		" am-train-lstm-streams-parallel scp:feature.scp ark:posterior.ark nnet.init nnet.iter1\n";
