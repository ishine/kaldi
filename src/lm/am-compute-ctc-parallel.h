...
#ifndef KALDI_LM_AM_COMPUTE_CTC_PARALLEL_H_
#define KALDI_LM_AM_COMPUTE_CTC_PARALLEL_H_
...
typedef nnet0::NnetCtcUpdateOptions NnetCtcUpdateOptions;
typedef nnet0::NnetCtcStats NnetCtcStats;
...
#endif // KALDI_LM_AM_COMPUTE_CTC_PARALLEL_H_
