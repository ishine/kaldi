...
#include "mace/mace-decodable-simple-looped.h"
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    MaceSimpleLoopedComputationOptions decodable_opts;
    ...
    model_file = "/home/liutuo/workspace/AI/liutuo/mace/build/cvte/model/cvte.pb";
    weight_file = "/home/liutuo/workspace/AI/liutuo/mace/build/cvte/model/cvte.data";
    const std::vector<std::string> input_nodes = {"input"};
    const std::vector<std::string> output_nodes = {"output.affine"};
    const std::vector<std::vector<int64_t>> input_shapes = {{1, 100, 40}};
    const std::vector<std::vector<int64_t>> output_shapes = {{1, 78, 6508}};
    ...
    if (ClassifyRspecifier(fst_in_str, NULL, NULL) == kNoRspecifier) {
...

      {
        ...
        for (; !feature_reader.Done(); feature_reader.Next()) {
          ...
          MaceDecodableAmNnetSimpleLooped nnet_decodable(
              decodable_info, trans_model, &computer, features, ivector, online_ivectors,
